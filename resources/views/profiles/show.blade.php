    ...
    <header class="mb-6 relative">
        ...
        <div class="relative">
            ...
            <img 
                src="{{ $user->avatar }}" 
                alt=""
                class="mr-2 absolute bottom-0 transform -translate-x-1/2 translate-y-1/2 rounded-full"
                style="left: 50%"
                width="150"
            >
        </div>
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex">
                @can('edit', $user)
                    <a href="{{ $user->path('edit') }}" class="rounded-full border border-gray-500 py-2 px-2 text-black text-xs mr-2">Edit Profile</a>
                @endcan
